...
3)	On the VM device open the Chrome Browser:
    ...
    {{< figure src="vm_access_2.jpg" alt="labAccess2" >}}
...
5)	Logon to FortiDLP with your assigned course credentials:
    ...
    {{< figure src="vm_access_3.jpg" alt="labAccess3" >}}

6)	Click the "Admin" icon:

    {{< figure src="vm_access_4.jpg" alt="labAccess4" class="zoomable">}}
...
12) When prompted, click "Finish" to complete the install:
    ...
    {{< figure src="vm_access_16.jpg" alt="labAccess16" >}}
